...
#define BOOMERANG_TURTLE_STATE_DIE_BY_TAIL_LEFT						500
#define BOOMERANG_TURTLE_STATE_DIE_BY_TAIL_RIGHT					600
...
#define BOOMERANG_TURTLE_WALKING_TIMEOUT_2							5000	// timeout between the second throw towards the next 2-throw
