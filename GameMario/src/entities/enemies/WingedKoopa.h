...
#define WINGED_KOOPA_GRAVITY_DECREMENT 0.00001f
...
#define WINGED_KOOPA_BOUNCING_SPEED_X 0.04f
...
#define WINGED_KOOPA_STATE_DIE_ON_DYNAMIC_KOOPA 520
#define WINGED_KOOPA_STATE_DIE_ON_HELD_KOOPA 530
