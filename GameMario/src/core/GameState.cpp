...
#include "entities/player/Mario.h" // Needed to get player state (P-meter)
#include "core/Game.h"  // Include Game for GetInstance, GetCamPos etc.
#include "engine/rendering/Sprites.h" // Include Sprites for GetInstance
