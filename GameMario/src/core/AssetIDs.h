...
#define OBJECT_TYPE_COIN_QBLOCK 10
#define OBJECT_TYPE_BUFF_QBLOCK 11
#define OBJECT_TYPE_KOOPA 12
#define OBJECT_TYPE_WINGED_GOOMBA 13
#define OBJECT_TYPE_LIFE_BRICK 14
#define OBJECT_TYPE_WINGED_KOOPA 15
#define OBJECT_TYPE_BOOMERANG 16
#define OBJECT_TYPE_BOOMERANG_TURTLE 17
#define OBJECT_TYPE_FLYING_KOOPA 18
#define OBJECT_TYPE_HIDDEN_COIN_BRICK 19
#define OBJECT_TYPE_FALLING_PLATFORM 20
...
#define OBJECT_TYPE_PIPE 103
#define OBJECT_TYPE_BUSH 104
#define OBJECT_TYPE_CLOUD 105
...
#define OBJECT_TYPE_ACTIVATOR_BRICK 110
#define OBJECT_TYPE_BUFF_ROULETTE	111
...
#define ID_SPRITE_BOX_TOP_LEFT (ID_SPRITE_BOX + 1000)
#define ID_SPRITE_BOX_TOP_CENTER (ID_SPRITE_BOX + 1001)
#define ID_SPRITE_BOX_TOP_RIGHT (ID_SPRITE_BOX + 1002)
#define ID_SPRITE_BOX_MIDDLE_LEFT (ID_SPRITE_BOX + 2000)
#define ID_SPRITE_BOX_MIDDLE_CENTER (ID_SPRITE_BOX + 2001)
#define ID_SPRITE_BOX_MIDDLE_RIGHT (ID_SPRITE_BOX + 2002)
#define ID_SPRITE_BOX_BOTTOM_LEFT (ID_SPRITE_BOX + 3000)
#define ID_SPRITE_BOX_BOTTOM_CENTER (ID_SPRITE_BOX + 3001)
#define ID_SPRITE_BOX_BOTTOM_RIGHT (ID_SPRITE_BOX + 3002)
#define ID_SPRITE_BOX_TOP_SHADOW (ID_SPRITE_BOX + 4000)
#define ID_SPRITE_BOX_MIDDLE_SHADOW (ID_SPRITE_BOX + 4001)
#define ID_SPRITE_BOX_BOTTOM_SHADOW (ID_SPRITE_BOX + 4002)
