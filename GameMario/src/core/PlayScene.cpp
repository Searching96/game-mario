...
#include "entities/player/TailWhip.h"
...
#include "world/SkyPlatform.h"
#include "systems/FallPitch.h"
...
#include "world/FallingPlatform.h"
#include "entities/blocks/BuffRoulette.h"
...
void CPlayScene::DefeatEnemiesOutOfRange()
{
	...
	// L?y t?t c? các enemy t? các chunk dã load
	...
	for (LPGAMEOBJECT enemy : allEnemies)
	{
		...
		// N?u enemy n?m ngoài ph?m vi camera + defeat range
		if (eX < camStartX - DEFEAT_RANGE || eX > camEndX + DEFEAT_RANGE)
		{
			// Ki?m tra lo?i enemy c? th? và dánh b?i nó
